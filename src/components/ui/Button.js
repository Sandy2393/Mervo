...
const Button = React.forwardRef(({ className, variant, size, asChild = false, isLoading, disabled, children, block, ...props }, ref) => {
    const Comp = asChild ? Slot : "button";
    return (_jsxs(Comp, { className: cn(buttonVariants({ variant, size }), block && "w-full", className), ref: ref, disabled: disabled || isLoading, ...props, children: [isLoading && _jsx(Spinner, { className: "mr-2" }), children] }));
});
